...
#### BCS ####
class Script_LUA1200a_Auto(inf_scripting.ScriptBase): # LUA1200a
	# None
	...
	def do_execute_block_01(cls, self, locus, code_from = None):
		...
		# CutSceneId(Player1)
		# LeaveAreaLUA("AR1200","LOAD1000",[2520.2454],10)  // Targos Palisade
	...
	def do_execute_block_01_code_01(cls, self, locus):
		...
		self.iLeaveAreaLUA("'AR1200'", "'LOAD1000'", "[2520.2454]", 10)
		return 0
	...
	def do_execute_block_02(cls, self, locus, code_from = None):
		...
		# CutSceneId(Player2)
		# LeaveAreaLUA("AR1200","LOAD1000",[2574.2473],8)  // Targos Palisade
	...
	def do_execute_block_02_code_01(cls, self, locus):
		...
		self.iLeaveAreaLUA("'AR1200'", "'LOAD1000'", "[2574.2473]", 8)
		return 0
	...
	def do_execute_block_03(cls, self, locus, code_from = None):
		...
		# CutSceneId(Player3)
		# LeaveAreaLUA("AR1200","LOAD1000",[2500.2407],12)  // Targos Palisade
	...
	def do_execute_block_03_code_01(cls, self, locus):
		...
		self.iLeaveAreaLUA("'AR1200'", "'LOAD1000'", "[2500.2407]", 12)
		return 0
	...
	def do_execute_block_04(cls, self, locus, code_from = None):
		...
		# CutSceneId(Player4)
		# LeaveAreaLUA("AR1200","LOAD1000",[2520.2358],14)  // Targos Palisade
	...
	def do_execute_block_04_code_01(cls, self, locus):
		...
		self.iLeaveAreaLUA("'AR1200'", "'LOAD1000'", "[2520.2358]", 14)
		return 0
	...
	def do_execute_block_05(cls, self, locus, code_from = None):
		...
		# CutSceneId(Player5)
		# LeaveAreaLUA("AR1200","LOAD1000",[2574.2340],0)  // Targos Palisade
	...
	def do_execute_block_05_code_01(cls, self, locus):
		...
		self.iLeaveAreaLUA("'AR1200'", "'LOAD1000'", "[2574.2340]", 0)
		return 0
	...
	def do_execute_block_06(cls, self, locus, code_from = None):
		...
		# CutSceneId(Player6)
		# LeaveAreaLUA("AR1200","LOAD1000",[2628.2358],2)  // Targos Palisade
	...
	def do_execute_block_06_code_01(cls, self, locus):
		...
		self.iLeaveAreaLUA("'AR1200'", "'LOAD1000'", "[2628.2358]", 2)
		return 0

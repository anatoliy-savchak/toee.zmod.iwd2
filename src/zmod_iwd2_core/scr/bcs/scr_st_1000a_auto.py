...
#### BCS ####
class Script_ST_1000a_Auto(inf_scripting.ScriptBase): # ST_1000a
	# None
	...
	def do_execute_block_01_code_03(cls, self, locus):
		...
		self.iMultiPlayerSync()
		self.iSetGlobal("'AR1000_RESET_CUTSCENE'", "'GLOBAL'", 1)
		self.iStopJoinRequests()
		self.iSetGlobal("'RJ_AR1000'", "'GLOBAL'", 1)
		self.iMultiPlayerSync()
		self.iStartCutScene(scr_lua1000a.Script_LUA1000a, locus)
		return 2

...
#### IMPORTS ####
from bcs import scr_lua1100a
#### END IMPORTS ####

#### BCS ####
class Script_ST_1100a_Auto(inf_scripting.ScriptBase): # ST_1100a
	# None
	...
	def do_execute_block_01_code_03(cls, self, locus):
		...
		self.iMultiPlayerSync()
		self.iSetGlobal("'AR1100_RESET_CUTSCENE'", "'GLOBAL'", 1)
		self.iStopJoinRequests()
		self.iSetGlobal("'RJ_AR1100'", "'GLOBAL'", 1)
		self.iMultiPlayerSync()
		self.iStartCutScene(scr_lua1100a.Script_LUA1100a, locus)
		return 2

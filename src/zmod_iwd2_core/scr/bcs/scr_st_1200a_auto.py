...
#### IMPORTS ####
from bcs import scr_lua1200a
#### END IMPORTS ####

#### BCS ####
class Script_ST_1200a_Auto(inf_scripting.ScriptBase): # ST_1200a
	# None
	...
	def do_execute_block_01_code_03(cls, self, locus):
		...
		self.iMultiPlayerSync()
		self.iStartCutScene(scr_lua1200a.Script_LUA1200a, locus)
		return 2

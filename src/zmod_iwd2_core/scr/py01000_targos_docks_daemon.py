...
class CtrlTargosDocks(ctrl_daemon2.CtrlDaemon2):
	...
	def place_npcs(self):
		...
		# Swift Thomas (Hidden): 12SWIFTH (503.3, 441.5) const_toee.ROT05 ctrl: None.None
		
		# Dead_Townsperson_2: 10MALED (547.2, 485.7) const_toee.ROT08 ctrl: None.None
		
		# Door_Hint_Text_00: 10HINT (475.3, 443.0) const_toee.ROT06 ctrl: None.None
		
		# Door_Hint_Text_01: 10HINT (442.2, 478.9) const_toee.ROT06 ctrl: None.None
		
		# Firtha Kerdos: 10FIRTHH (529.7, 495.4) const_toee.ROT06 ctrl: None.None

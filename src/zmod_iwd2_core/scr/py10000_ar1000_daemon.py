...
class CtrlTargosDocks(ctrl_daemon_ie.CtrlDaemonIE):
	...
	def setup_ambients(self):
		...
		amb.setup_sound(sound_id=4116, durationf=4.331565, volume=90, title="AR1000\Horn_Blow AM1000J")
		self.ambients.append(amb)
		...
		amb.setup_sound(sound_id=4117, durationf=7.282721, volume=75, title="AR1000\goblin_walla AM1000F1")
		amb.setup_sound(sound_id=4118, durationf=3.48907, volume=75, title="AR1000\goblin_walla AM1000F2")
		amb.setup_sound(sound_id=4119, durationf=4.923673, volume=75, title="AR1000\goblin_walla AM1000F3")
		amb.setup_sound(sound_id=4120, durationf=6.028889, volume=75, title="AR1000\goblin_walla AM1000F4")
		amb.setup_sound(sound_id=4121, durationf=4.349569, volume=75, title="AR1000\goblin_walla AM1000F5")
		amb.setup_sound(sound_id=4122, durationf=4.055918, volume=75, title="AR1000\goblin_walla AM1000F6")
		amb.setup_sound(sound_id=4123, durationf=4.761179, volume=75, title="AR1000\goblin_walla AM1000F7")
		amb.setup_sound(sound_id=4124, durationf=3.722993, volume=75, title="AR1000\goblin_walla AM1000F8")
		amb.setup_sound(sound_id=4125, durationf=4.497143, volume=75, title="AR1000\goblin_walla AM1000F9")
		self.ambients.append(amb)
		...
		amb.setup_sound(sound_id=4126, durationf=3.180363, volume=70, title="AR1000\Water laps1 AM1000A1")
		amb.setup_sound(sound_id=4127, durationf=2.797007, volume=70, title="AR1000\Water laps1 AM1000A2")
		amb.setup_sound(sound_id=4128, durationf=3.360136, volume=70, title="AR1000\Water laps1 AM1000A3")
		amb.setup_sound(sound_id=4129, durationf=3.220816, volume=70, title="AR1000\Water laps1 AM1000A4")
		amb.setup_sound(sound_id=4130, durationf=3.722585, volume=70, title="AR1000\Water laps1 AM1000A5")
		amb.setup_sound(sound_id=4131, durationf=3.123673, volume=70, title="AR1000\Water laps1 AM1000A6")
		self.ambients.append(amb)
		...
		amb.setup_sound(sound_id=4132, durationf=2.911156, volume=60, title="AR1000\Dock Creaks1 AM1000B1")
		amb.setup_sound(sound_id=4133, durationf=2.328934, volume=60, title="AR1000\Dock Creaks1 AM1000B2")
		amb.setup_sound(sound_id=4134, durationf=3.767347, volume=60, title="AR1000\Dock Creaks1 AM1000B3")
		amb.setup_sound(sound_id=4135, durationf=4.462993, volume=60, title="AR1000\Dock Creaks1 AM1000B4")
		amb.setup_sound(sound_id=4136, durationf=3.065215, volume=60, title="AR1000\Dock Creaks1 AM1000B5")
		amb.setup_sound(sound_id=4137, durationf=3.536508, volume=60, title="AR1000\Dock Creaks1 AM1000B6")
		self.ambients.append(amb)
		...
		amb.setup_sound(sound_id=4143, durationf=0.940181, volume=100, title="AR1000\cat_singles_exterior AM1000P1")
		amb.setup_sound(sound_id=4144, durationf=1.3639, volume=100, title="AR1000\cat_singles_exterior AM1000P2")
		amb.setup_sound(sound_id=4145, durationf=1.08585, volume=100, title="AR1000\cat_singles_exterior AM1000P3")
		amb.setup_sound(sound_id=4146, durationf=1.092472, volume=100, title="AR1000\cat_singles_exterior AM1000P4")
		amb.setup_sound(sound_id=4147, durationf=1.08585, volume=100, title="AR1000\cat_singles_exterior AM1000P5")
		self.ambients.append(amb)
		...
		amb.setup_sound(sound_id=4149, durationf=6.027302, volume=60, title="AR1000\tavern_walla_ext AM1000I1")
		amb.setup_sound(sound_id=4150, durationf=3.67034, volume=60, title="AR1000\tavern_walla_ext AM1000I2")
		amb.setup_sound(sound_id=4151, durationf=4.838186, volume=60, title="AR1000\tavern_walla_ext AM1000I3")
		amb.setup_sound(sound_id=4152, durationf=6.64, volume=60, title="AR1000\tavern_walla_ext AM1000I4")
		amb.setup_sound(sound_id=4153, durationf=5.138503, volume=60, title="AR1000\tavern_walla_ext AM1000I5")
		amb.setup_sound(sound_id=4154, durationf=2.636009, volume=60, title="AR1000\tavern_walla_ext AM1000I6")
		amb.setup_sound(sound_id=4155, durationf=6.373061, volume=60, title="AR1000\tavern_walla_ext AM1000I7")
		self.ambients.append(amb)

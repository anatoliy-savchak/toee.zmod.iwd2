...
class Ctrl_12SWIFTH_Auto(ctrl_behaviour_ie.CtrlBehaviourIE): # 12SWIFTH 
	...
	def script_dialog(self, attachee, triggerer):
		...
		while True:
			...
			# NumTimesTalkedTo(0)
			if self.iNumTimesTalkedTo(0):
				line_id = 1720 # You're one of those mercenaries that slaughtered those goblins at the docks, aren't you?  I wish I could have been there!
				print("STATE 0: line_id = 1720")
				break
			
			print("STATE 5")
			# NumTimesTalkedToGT(0)
			if self.iNumTimesTalkedToGT(0):
				line_id = 1770 # I *knew* I'd see you again - see any more goblins?
				print("STATE 5: line_id = 1770")
				break
			
			print("STATE 6")
			# Global("Thomas_Permission", "GLOBAL", 2)
			if self.iGlobal("'Thomas_Permission'", "'GLOBAL'", 2):
				line_id = 1780 # Take you somewhere?
				print("STATE 6: line_id = 1780")
				break
			...
			if self.iGlobal("'AR2000_Visited'", "'GLOBAL'", 1) \
				...
				line_id = 1800 # Did you go to Shaengarne?!  I bet you did!  Did you see any boars?!  Hunh?
				print("STATE 7: line_id = 1800")
				break
			
			print("STATE 11")
			# Global("AR3000_Visited", "GLOBAL", 1)
			if self.iGlobal("'AR3000_Visited'", "'GLOBAL'", 1):
				line_id = 1830 # Did you see any goblins?!  I heard you went out to their fortress to make a mountain out of their heads!
				print("STATE 11: line_id = 1830")
				break
	...
	def dialog_test_do(self, npc, pc, index):
		...
		if index == 0:
			...
			if self.iGlobalGT("'Lumber_Quest'", "'GLOBAL'", 1) \
				...
				return True # 1731: Olap told us you could show us the fastest route through Targos.
			...
			if self.iCheckSkillGT("Protagonist", 0, "Bluff") \
				...
				return True # 1732: Uh, Olap told us you could show us the fastest route through Targos.
			
		elif index == 2:
			# Global("Lumber_Quest", "GLOBAL", 0)
			if self.iGlobal("'Lumber_Quest'", "'GLOBAL'", 0):
				return True # 1734: Well, everybody's got to serve somebody.  Do you know where I can find the Commander of the Guard?
			...
			if self.iGlobalGT("'Lumber_Quest'", "'GLOBAL'", 1) \
				 and self.iGlobal("'Thomas_Permission'", "'GLOBAL'", 1):
				return True # 1751: It so happens I am doing a job for the Guard.
			...
			if self.iCheckSkillGT("Protagonist", 0, "Bluff") \
				 and self.iGlobalGT("'Lumber_Quest'", "'GLOBAL'", 1) \
				 and self.iGlobal("'Thomas_Permission'", "'GLOBAL'", 0):
				return True # 1752: Uh, well, it so happens I am doing a job for the Guard.  Very important.
			
		elif index == 5:
			# Global("Lumber_Quest", "GLOBAL", 0)
			if self.iGlobal("'Lumber_Quest'", "'GLOBAL'", 0):
				return True # 1753: Do you know where I can find the Commander of the Guard?
			
		elif index == 6:
			# !CurrentAreaIs(Protagonist,1000)
			if not self.iCurrentAreaIs("Protagonist", 1000):
				return True # 1741: Can you take us to the Docks?
			
		elif index == 7:
			# !CurrentAreaIs(Protagonist,1100)
			if not self.iCurrentAreaIs("Protagonist", 1100):
				return True # 1742: We'd like to go into town.
			...
			if not self.iCurrentAreaIs("Protagonist", 1200) \
				...
				return True # 1743: To the Palisade.
			...
			if not self.iCurrentAreaIs("Protagonist", 1200) \
				...
				return True # 1744: To the Palisade.
			...
			if self.iGlobalGT("'Lumber_Quest'", "'GLOBAL'", 1) \
				 and self.iGlobal("'Thomas_Permission'", "'GLOBAL'", 1):
				return True # 1771: Olap told us you could show us the fastest route through Targos.
			...
			if self.iCheckSkillGT("Protagonist", 0, "Bluff") \
				 and self.iGlobalGT("'Lumber_Quest'", "'GLOBAL'", 1) \
				 and self.iGlobal("'Thomas_Permission'", "'GLOBAL'", 0):
				return True # 1772: Uh, Olap told us you could show us the fastest route through Targos.
			...
			if not self.iCurrentAreaIs("Protagonist", 1000) \
				...
				return True # 1773: Not at the moment.  Can you take us to the Docks?
			...
			if not self.iCurrentAreaIs("Protagonist", 1100) \
				 and self.iGlobal("'Thomas_Permission'", "'GLOBAL'", 2):
				return True # 1774: We'd like to go into town.
			...
			if not self.iCurrentAreaIs("Protagonist", 1200) \
				 and self.iGlobal("'Goblin_Palisade_Quest'", "'GLOBAL'", 0):
				return True # 1775: No, but we need to head to the Palisade.
			...
			if not self.iCurrentAreaIs("Protagonist", 1200) \
				 and self.iGlobalGT("'Goblin_Palisade_Quest'", "'GLOBAL'", 0):
				return True # 1776: No, but we need to head to the Palisade.
			...
			if self.iGlobal("'Jump_Check'", "'GLOBAL'", 1) \
				...
				return True # 1781: Uh, when I last saw you, Thomas, you were at the Docks.
			...
			if self.iGlobal("'Jump_Check'", "'GLOBAL'", 2) \
				...
				return True # 1782: Weren't you at the Palisade when I saw you last?
			...
			if self.iGlobal("'Jump_Check'", "'GLOBAL'", 3) \
				...
				return True # 1783: Uh, Thomas, weren't you in town when I saw you last?
			
		elif index == 19:
			# !CurrentAreaIs(Protagonist,1000)
			if not self.iCurrentAreaIs("Protagonist", 1000):
				return True # 1784: Can you take us to the Docks?
			
		elif index == 20:
			# !CurrentAreaIs(Protagonist,1100)
			if not self.iCurrentAreaIs("Protagonist", 1100):
				return True # 1785: We'd like to go into town.
			...
			if not self.iCurrentAreaIs("Protagonist", 1200) \
				 and self.iGlobal("'Goblin_Palisade_Quest'", "'GLOBAL'", 0):
				return True # 1786: To the Palisade.
			...
			if not self.iCurrentAreaIs("Protagonist", 1200) \
				 and self.iGlobalGT("'Goblin_Palisade_Quest'", "'GLOBAL'", 0):
				return True # 1787: To the Palisade.
			
		elif index == 23:
			# !CurrentAreaIs(Protagonist,1000)
			if not self.iCurrentAreaIs("Protagonist", 1000):
				return True # 1802: Can you take us to the Docks?
			
		elif index == 24:
			# !CurrentAreaIs(Protagonist,1100)
			if not self.iCurrentAreaIs("Protagonist", 1100):
				return True # 1803: We'd like to go into town.
			...
			if not self.iCurrentAreaIs("Protagonist", 1200) \
				 and self.iGlobal("'Goblin_Palisade_Quest'", "'GLOBAL'", 0):
				return True # 1804: We need to head to the Palisade.
			...
			if not self.iCurrentAreaIs("Protagonist", 1200) \
				 and self.iGlobalGT("'Goblin_Palisade_Quest'", "'GLOBAL'", 0):
				return True # 1805: We need to head to the Palisade.
			
		elif index == 27:
			# !CurrentAreaIs(Protagonist,1000)
			if not self.iCurrentAreaIs("Protagonist", 1000):
				return True # 1791: Uh, sure.  Take me to the Docks, then.
			
		elif index == 28:
			# !CurrentAreaIs(Protagonist,1100)
			if not self.iCurrentAreaIs("Protagonist", 1100):
				return True # 1792: Well, prove it and take me into town, then.
			...
			if not self.iCurrentAreaIs("Protagonist", 1200) \
				 and self.iGlobal("'Goblin_Palisade_Quest'", "'GLOBAL'", 0):
				return True # 1793: To the Palisade, then, fleetfoot.
			...
			if not self.iCurrentAreaIs("Protagonist", 1200) \
				 and self.iGlobalGT("'Goblin_Palisade_Quest'", "'GLOBAL'", 0):
				return True # 1794: To the Palisade, then, fleetfoot.
			
		elif index == 31:
			# !CurrentAreaIs(Protagonist,1000)
			if not self.iCurrentAreaIs("Protagonist", 1000):
				return True # 1812: Can you take us to the Docks?
			
		elif index == 32:
			# !CurrentAreaIs(Protagonist,1100)
			if not self.iCurrentAreaIs("Protagonist", 1100):
				return True # 1813: We'd like to go into town.
			...
			if not self.iCurrentAreaIs("Protagonist", 1200) \
				 and self.iGlobal("'Goblin_Palisade_Quest'", "'GLOBAL'", 0):
				return True # 1814: We need to head to the Palisade.
			...
			if not self.iCurrentAreaIs("Protagonist", 1200) \
				 and self.iGlobalGT("'Goblin_Palisade_Quest'", "'GLOBAL'", 0):
				return True # 1815: We need to head to the Palisade.
			
		elif index == 35:
			# !CurrentAreaIs(Protagonist,1000)
			if not self.iCurrentAreaIs("Protagonist", 1000):
				return True # 1821: Yeah, anyway, can you take us to the Docks?
			
		elif index == 36:
			# !CurrentAreaIs(Protagonist,1100)
			if not self.iCurrentAreaIs("Protagonist", 1100):
				return True # 1822: Sure would.  Now can you take us into town?
			...
			if not self.iCurrentAreaIs("Protagonist", 1200) \
				 and self.iGlobal("'Goblin_Palisade_Quest'", "'GLOBAL'", 0):
				return True # 1823: Epic doesn't begin to cover it.  Can you take us to the Palisade?
			...
			if not self.iCurrentAreaIs("Protagonist", 1200) \
				 and self.iGlobalGT("'Goblin_Palisade_Quest'", "'GLOBAL'", 0):
				return True # 1824: Epic doesn't begin to cover it.  Can you take us to the Palisade?
			
		elif index == 39:
			# !CurrentAreaIs(Protagonist,1000)
			if not self.iCurrentAreaIs("Protagonist", 1000):
				return True # 1833: Yeah, anyway, Thomas, can you take us to the Docks?
			
		elif index == 40:
			# !CurrentAreaIs(Protagonist,1100)
			if not self.iCurrentAreaIs("Protagonist", 1100):
				return True # 1834: All in a day's work.  Now can you take us into town?
			...
			if not self.iCurrentAreaIs("Protagonist", 1200) \
				 and self.iGlobal("'Goblin_Palisade_Quest'", "'GLOBAL'", 0):
				return True # 1835: That's about right.  Can you take us to the Palisade?
			...
			if not self.iCurrentAreaIs("Protagonist", 1200) \
				 and self.iGlobalGT("'Goblin_Palisade_Quest'", "'GLOBAL'", 0):
				return True # 1836: That's about right.  Can you take us to the Palisade?
			
		elif index == 43:
			# !CurrentAreaIs(Protagonist,1000)
			if not self.iCurrentAreaIs("Protagonist", 1000):
				return True # 1841: My feet are already singing a song.  Now can you take us to the Docks?
			
		elif index == 44:
			# !CurrentAreaIs(Protagonist,1100)
			if not self.iCurrentAreaIs("Protagonist", 1100):
				return True # 1842: Can't wait to hear them.  For now, can you take me into town?
			...
			if not self.iCurrentAreaIs("Protagonist", 1200) \
				 and self.iGlobal("'Goblin_Palisade_Quest'", "'GLOBAL'", 0):
				return True # 1843: Sure they will.  Can you take us to the Palisade?
			...
			if not self.iCurrentAreaIs("Protagonist", 1200) \
				 and self.iGlobalGT("'Goblin_Palisade_Quest'", "'GLOBAL'", 0):
				return True # 1844: Sure they will.  Can you take us to the Palisade?
	...
	def dialog_action_do(self, npc, pc, index):
		...
		if index == 0:
			...
			# 1721: Be glad you weren't there, child - one should never wish to be in battle, only wish to be kept far from it.
			
		elif index == 1:
			# SetGlobal("Know_Swift_Thomas", "GLOBAL", 1)
			self.iSetGlobal("'Know_Swift_Thomas'", "'GLOBAL'", 1)
			# 1722: Well, let me tell you, we could have used a hand or two.  The Targos Guard were scattered like geese.
			
		elif index == 2:
			# SetGlobal("Know_Swift_Thomas", "GLOBAL", 1)
			self.iSetGlobal("'Know_Swift_Thomas'", "'GLOBAL'", 1)
			# 1723: If you'd been there, you'd have died like the other soldiers and townsfolk, boy.
			
		elif index == 3:
			# SetGlobal("Thomas_Permission", "GLOBAL", 2)
			self.iSetGlobal("'Thomas_Permission'", "'GLOBAL'", 2)
			# 1731: Olap told us you could show us the fastest route through Targos.
			
		elif index == 4:
			# SetGlobal("Thomas_Permission", "GLOBAL", 2)
			self.iSetGlobal("'Thomas_Permission'", "'GLOBAL'", 2)
			# 1732: Uh, Olap told us you could show us the fastest route through Targos.
			
		elif index == 5:
			# SetGlobal("Thomas_Permission", "GLOBAL", 2)
			self.iSetGlobal("'Thomas_Permission'", "'GLOBAL'", 2)
			# 1751: It so happens I am doing a job for the Guard.
			
		elif index == 6:
			# SetGlobal("Thomas_Permission", "GLOBAL", 2)
			self.iSetGlobal("'Thomas_Permission'", "'GLOBAL'", 2)
			# 1752: Uh, well, it so happens I am doing a job for the Guard.  Very important.
			...
			# 1741: Can you take us to the Docks?
			...
			# 1742: We'd like to go into town.
			...
			# 1744: To the Palisade.
			
		elif index == 11:
			# SetGlobal("Thomas_Permission", "GLOBAL", 2)
			self.iSetGlobal("'Thomas_Permission'", "'GLOBAL'", 2)
			# 1771: Olap told us you could show us the fastest route through Targos.
			
		elif index == 12:
			# SetGlobal("Thomas_Permission", "GLOBAL", 2)
			self.iSetGlobal("'Thomas_Permission'", "'GLOBAL'", 2)
			# 1772: Uh, Olap told us you could show us the fastest route through Targos.
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1000a.Script_ST_1000a, self.locus_make())
			# 1773: Not at the moment.  Can you take us to the Docks?
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1100a.Script_ST_1100a, self.locus_make())
			# 1774: We'd like to go into town.
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1200a.Script_ST_1200a, self.locus_make())
			# 1775: No, but we need to head to the Palisade.
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1200b.Script_ST_1200b, self.locus_make())
			# 1776: No, but we need to head to the Palisade.
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1000a.Script_ST_1000a, self.locus_make())
			# 1784: Can you take us to the Docks?
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1100a.Script_ST_1100a, self.locus_make())
			# 1785: We'd like to go into town.
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1000a.Script_ST_1000a, self.locus_make())
			# 1802: Can you take us to the Docks?
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1100a.Script_ST_1100a, self.locus_make())
			# 1803: We'd like to go into town.
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1200a.Script_ST_1200a, self.locus_make())
			# 1804: We need to head to the Palisade.
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1200b.Script_ST_1200b, self.locus_make())
			# 1805: We need to head to the Palisade.
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1000a.Script_ST_1000a, self.locus_make())
			# 1791: Uh, sure.  Take me to the Docks, then.
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1100a.Script_ST_1100a, self.locus_make())
			# 1792: Well, prove it and take me into town, then.
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1200a.Script_ST_1200a, self.locus_make())
			# 1793: To the Palisade, then, fleetfoot.
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1200b.Script_ST_1200b, self.locus_make())
			# 1794: To the Palisade, then, fleetfoot.
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1000a.Script_ST_1000a, self.locus_make())
			# 1812: Can you take us to the Docks?
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1100a.Script_ST_1100a, self.locus_make())
			# 1813: We'd like to go into town.
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1200a.Script_ST_1200a, self.locus_make())
			# 1814: We need to head to the Palisade.
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1200b.Script_ST_1200b, self.locus_make())
			# 1815: We need to head to the Palisade.
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1000a.Script_ST_1000a, self.locus_make())
			# 1821: Yeah, anyway, can you take us to the Docks?
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1100a.Script_ST_1100a, self.locus_make())
			# 1822: Sure would.  Now can you take us into town?
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1200a.Script_ST_1200a, self.locus_make())
			# 1823: Epic doesn't begin to cover it.  Can you take us to the Palisade?
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1200b.Script_ST_1200b, self.locus_make())
			# 1824: Epic doesn't begin to cover it.  Can you take us to the Palisade?
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1000a.Script_ST_1000a, self.locus_make())
			# 1833: Yeah, anyway, Thomas, can you take us to the Docks?
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1100a.Script_ST_1100a, self.locus_make())
			# 1834: All in a day's work.  Now can you take us into town?
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1200a.Script_ST_1200a, self.locus_make())
			# 1835: That's about right.  Can you take us to the Palisade?
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1200b.Script_ST_1200b, self.locus_make())
			# 1836: That's about right.  Can you take us to the Palisade?
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1000a.Script_ST_1000a, self.locus_make())
			# 1841: My feet are already singing a song.  Now can you take us to the Docks?
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1100a.Script_ST_1100a, self.locus_make())
			# 1842: Can't wait to hear them.  For now, can you take me into town?
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1200a.Script_ST_1200a, self.locus_make())
			# 1843: Sure they will.  Can you take us to the Palisade?
			...
			self.iStartCutSceneMode(is_from_dialog=True)
			self.iStartCutScenePost(scr_st_1200b.Script_ST_1200b, self.locus_make())
			# 1844: Sure they will.  Can you take us to the Palisade?
	...
	def get_state_to_line(self, state):
		if state==0: return 1720
		if state==1: return 1730
		if state==2: return 1750
		if state==3: return 1760
		if state==4: return 1740
		if state==5: return 1770
		if state==6: return 1780
		if state==7: return 1800
		if state==8: return 1790
		if state==9: return 1810
		if state==10: return 1820
		if state==11: return 1830
		if state==12: return 1840
		return
	
class Ctrl_10HINT_Auto(ctrl_behaviour_ie.CtrlBehaviourIE): # 10HINT 
	@classmethod
	def get_proto_id(cls): return const_proto_npc.PROTO_NPC_MAN
	
	def setup_scripts(self, npc):
		super(Ctrl_10HINT_Auto, self).setup_scripts(npc)
		return
	
	def setup_appearance(self, npc):
		utils_npc.npc_description_set_new(npc, "Hint")
		
		# npc.obj_set_int(toee.obj_f_critter_portrait, 8680) # none
		
		hairStyle = utils_npc.HairStyle.from_npc(npc)
		hairStyle.style = const_toee.hair_style_longhair
		hairStyle.color = const_toee.hair_color_black # HairColourIndex: 79
		hairStyle.update_npc(npc)
		return
	
	def setup_char(self, npc):
		utils_npc.npc_abilities_set(npc, [11, 11, 11, 11, 11, 11])
	...
	def setup_gear(self, npc):
		utils_item.item_create_in_inventory2(const_proto_cloth.PROTO_CLOTH_GARB_MYSTIC_WHITE, npc, no_loot = True, wear_on = toee.item_wear_armor) # CLOTH WHITE
		utils_item.item_create_in_inventory2(const_proto_cloth.PROTO_CLOTH_BOOTS_LEATHER_BOOTS_FINE, npc, no_loot = True, wear_on = toee.item_wear_boots)
		return
	
class Ctrl_10FIRTHH_Auto(ctrl_behaviour_ie.CtrlBehaviourIE): # 10FIRTHH 
	@classmethod
	def get_proto_id(cls): return const_proto_npc.PROTO_NPC_MAN
	
	def setup_scripts(self, npc):
		super(Ctrl_10FIRTHH_Auto, self).setup_scripts(npc)
		return
	
	def setup_appearance(self, npc):
		utils_npc.npc_description_set_new(npc, "Firtha Kerdos")

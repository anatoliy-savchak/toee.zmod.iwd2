...
import const_proto_armor_iwd2, ctrl_behaviour_ie, const_proto_items_iwd2, ctrl_daemon, const_iwd2
...
class Ctrl_21GAERNT_AR2100_Gaernat_Sharptooth(py21003_ar2100_npc_inst_classes_auto.Ctrl_21GAERNT_AR2100_Gaernat_Sharptooth_Auto): # 21GAERNT 
	def setup_scripts(self, npc):
		super(Ctrl_21GAERNT_AR2100_Gaernat_Sharptooth, self).setup_scripts(npc)
	...
	def heartbeat(self, attachee, triggerer):
		...
		if self.generic_heartbeat_dialog_start_when_in_range(attachee, 75 // const_iwd2.IWD2_PIXELS_IN_FEAT):
